 ...
 * \sa SDL_WriteAsyncIO
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_AsyncIOFromFile")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetAsyncIOSize")))
 ...
 * \sa SDL_CreateAsyncIOQueue
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ReadAsyncIO")))
 ...
 * \sa SDL_CreateAsyncIOQueue
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_WriteAsyncIO")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_CloseAsyncIO")))
 ...
 * \sa SDL_WaitAsyncIOResult
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_CreateAsyncIOQueue")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_DestroyAsyncIOQueue")))
 ...
 * \sa SDL_WaitAsyncIOResult
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetAsyncIOResult")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_WaitAsyncIOResult")))
 ...
 * \sa SDL_WaitAsyncIOResult
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SignalAsyncIOQueue")))
 ...
 * \sa SDL_LoadFile_IO
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_LoadFileAsync")))
