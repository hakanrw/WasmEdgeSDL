 ...
 * \sa SDL_ShowFileDialogWithProperties
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ShowOpenFileDialog")))
 ...
 * \sa SDL_ShowFileDialogWithProperties
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ShowSaveFileDialog")))
 ...
 * \sa SDL_ShowFileDialogWithProperties
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ShowOpenFolderDialog")))
 ...
 * \sa SDL_ShowOpenFolderDialog
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ShowFileDialogWithProperties")))
