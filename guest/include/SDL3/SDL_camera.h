 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetNumCameraDrivers")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCameraDriver")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCurrentCameraDriver")))
 ...
 * \sa SDL_OpenCamera
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCameras")))
 ...
 * \sa SDL_OpenCamera
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCameraSupportedFormats")))
 ...
 * \sa SDL_GetCameras
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCameraName")))
 ...
 * \sa SDL_GetCameras
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCameraPosition")))
 ...
 * \sa SDL_GetCameraFormat
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_OpenCamera")))
 ...
 * \sa SDL_CloseCamera
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCameraPermissionState")))
 ...
 * \sa SDL_OpenCamera
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCameraID")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCameraProperties")))
 ...
 * \sa SDL_OpenCamera
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetCameraFormat")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_AcquireCameraFrame")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ReleaseCameraFrame")))
 ...
 * \sa SDL_OpenCamera
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_CloseCamera")))
