 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_CreateProcess")))
 ...
 * \sa SDL_DestroyProcess
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_CreateProcessWithProperties")))
 ...
 * \sa SDL_CreateProcessWithProperties
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetProcessProperties")))
 ...
 * \sa SDL_DestroyProcess
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ReadProcess")))
 ...
 * \sa SDL_GetProcessOutput
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetProcessInput")))
 ...
 * \sa SDL_GetProcessInput
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetProcessOutput")))
 ...
 * \sa SDL_DestroyProcess
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_KillProcess")))
 ...
 * \sa SDL_DestroyProcess
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_WaitProcess")))
 ...
 * \sa SDL_KillProcess
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_DestroyProcess")))
