 ...
 * \sa SDL_GetKeyboards
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_HasKeyboard")))
 ...
 * \sa SDL_HasKeyboard
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetKeyboards")))
 ...
 * \sa SDL_GetKeyboards
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetKeyboardNameForID")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetKeyboardFocus")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetKeyboardState")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ResetKeyboard")))
 ...
 * \sa SDL_SetModState
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetModState")))
 ...
 * \sa SDL_GetModState
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetModState")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetKeyFromScancode")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetScancodeFromKey")))
 ...
 * \sa SDL_GetScancodeName
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetScancodeName")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetScancodeName")))
 ...
 * \sa SDL_GetScancodeName
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetScancodeFromName")))
 ...
 * \sa SDL_GetScancodeFromKey
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetKeyName")))
 ...
 * \sa SDL_GetScancodeFromName
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetKeyFromName")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_StartTextInput")))
 ...
 * \sa SDL_TextInputActive
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_StartTextInputWithProperties")))
 ...
 * \sa SDL_StartTextInput
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_TextInputActive")))
 ...
 * \sa SDL_StartTextInput
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_StopTextInput")))
 ...
 * \sa SDL_StopTextInput
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ClearComposition")))
 ...
 * \sa SDL_StartTextInput
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetTextInputArea")))
 ...
 * \sa SDL_SetTextInputArea
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetTextInputArea")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_HasScreenKeyboardSupport")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ScreenKeyboardShown")))
