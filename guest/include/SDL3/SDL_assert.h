 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ReportAssertion")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetAssertionHandler")))
 ...
 * \sa SDL_GetAssertionHandler
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetDefaultAssertionHandler")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetAssertionHandler")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetAssertionReport")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ResetAssertionReport")))
