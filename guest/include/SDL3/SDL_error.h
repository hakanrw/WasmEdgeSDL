 ...
 * \sa SDL_SetErrorV
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetError")))
 ...
 * \sa SDL_SetError
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetErrorV")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_OutOfMemory")))
 ...
 * \sa SDL_SetError
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetError")))
 ...
 * \sa SDL_SetError
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ClearError")))
