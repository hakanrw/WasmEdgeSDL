 ...
 * \sa SDL_WasInit
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Init")))
 ...
 * \sa SDL_QuitSubSystem
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_InitSubSystem")))
 ...
 * \sa SDL_Quit
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_QuitSubSystem")))
 ...
 * \sa SDL_InitSubSystem
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_WasInit")))
 ...
 * \sa SDL_QuitSubSystem
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Quit")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_IsMainThread")))
 ...
 * \sa SDL_IsMainThread
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_RunOnMainThread")))
 ...
 * \sa SDL_SetAppMetadataProperty
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetAppMetadata")))
 ...
 * \sa SDL_SetAppMetadata
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetAppMetadataProperty")))
 ...
 * \sa SDL_SetAppMetadataProperty
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetAppMetadataProperty")))
