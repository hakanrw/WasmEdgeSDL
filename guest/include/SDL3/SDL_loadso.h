 ...
 * \sa SDL_UnloadObject
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_LoadObject")))
 ...
 * \sa SDL_LoadObject
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_LoadFunction")))
 ...
 * \sa SDL_LoadObject
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_UnloadObject")))
