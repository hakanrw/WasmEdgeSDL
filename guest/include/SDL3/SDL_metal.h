 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Metal_CreateView")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Metal_DestroyView")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Metal_GetLayer")))
