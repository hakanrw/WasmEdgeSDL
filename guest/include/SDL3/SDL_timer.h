 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetTicks")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetTicksNS")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetPerformanceCounter")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetPerformanceFrequency")))
 ...
 * \sa SDL_DelayPrecise
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Delay")))
 ...
 * \sa SDL_DelayPrecise
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_DelayNS")))
 ...
 * \sa SDL_DelayNS
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_DelayPrecise")))
 ...
 * \sa SDL_RemoveTimer
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_AddTimer")))
 ...
 * \sa SDL_RemoveTimer
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_AddTimerNS")))
 ...
 * \sa SDL_AddTimer
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_RemoveTimer")))
