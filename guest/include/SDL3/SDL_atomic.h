 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_TryLockSpinlock")))
 ...
 * \sa SDL_UnlockSpinlock
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_LockSpinlock")))
 ...
 * \sa SDL_TryLockSpinlock
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_UnlockSpinlock")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_MemoryBarrierReleaseFunction")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_MemoryBarrierAcquireFunction")))
 ...
 * \sa SDL_SetAtomicInt
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_CompareAndSwapAtomicInt")))
 ...
 * \sa SDL_GetAtomicInt
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetAtomicInt")))
 ...
 * \sa SDL_SetAtomicInt
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetAtomicInt")))
 ...
 * \sa SDL_AtomicIncRef
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_AddAtomicInt")))
 ...
 * \sa SDL_SetAtomicU32
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_CompareAndSwapAtomicU32")))
 ...
 * \sa SDL_GetAtomicU32
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetAtomicU32")))
 ...
 * \sa SDL_SetAtomicU32
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetAtomicU32")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_CompareAndSwapAtomicPointer")))
 ...
 * \sa SDL_GetAtomicPointer
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetAtomicPointer")))
 ...
 * \sa SDL_SetAtomicPointer
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetAtomicPointer")))
