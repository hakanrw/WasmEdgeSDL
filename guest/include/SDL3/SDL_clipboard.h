 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetClipboardText")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetClipboardText")))
 ...
 * \sa SDL_SetClipboardText
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_HasClipboardText")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetPrimarySelectionText")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetPrimarySelectionText")))
 ...
 * \sa SDL_SetPrimarySelectionText
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_HasPrimarySelectionText")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetClipboardData")))
 ...
 * \sa SDL_SetClipboardData
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_ClearClipboardData")))
 ...
 * \sa SDL_SetClipboardData
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetClipboardData")))
 ...
 * \sa SDL_GetClipboardData
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_HasClipboardData")))
 ...
 * \sa SDL_SetClipboardData
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetClipboardMimeTypes")))
