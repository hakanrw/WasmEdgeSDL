 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Vulkan_LoadLibrary")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Vulkan_GetVkGetInstanceProcAddr")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Vulkan_UnloadLibrary")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Vulkan_GetInstanceExtensions")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Vulkan_CreateSurface")))
 ...
 * \sa SDL_Vulkan_CreateSurface
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Vulkan_DestroySurface")))
 ...
 * \sa SDL_Vulkan_GetInstanceExtensions
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_Vulkan_GetPresentationSupport")))
