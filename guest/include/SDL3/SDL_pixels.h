 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetPixelFormatName")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetMasksForPixelFormat")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetPixelFormatForMasks")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetPixelFormatDetails")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_CreatePalette")))
 ...
 * \since This function is available since SDL 3.2.0.
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_SetPaletteColors")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_DestroyPalette")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_MapRGB")))
 ...
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_MapRGBA")))
 ...
 * \sa SDL_MapRGBA
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetRGB")))
 ...
 * \sa SDL_MapRGBA
 */
__attribute__((import_module("WasmEdgeSDL"), import_name("SDL_GetRGBA")))
